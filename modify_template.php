<? include("begin.php"); ?>
	...
	<? 
		...
		if (($id_supplier=="add")||($id_location=="add")||($id_precise_location=="add")||
			...
			<form method="post" action="modify_template.php" > <?
		...
		?> 
		Template successfully modified! <br>
	...
	?>
	<? } else { ?>
	<p> You are not allowed to modify a template that does not belong to your lab.</p>
	<?}?>
